...
/*
 * The reason for editing this file is that it both contains an bug fixes and serves to print errors through our own template system.
 * 
...
class HtmlErrorRenderer implements ErrorRendererInterface
{
    ...
    private function abbrClass(string $class): string
    {
        ...
        return sprintf('<span title="%s">%s</span>', $class, $short);
    }
