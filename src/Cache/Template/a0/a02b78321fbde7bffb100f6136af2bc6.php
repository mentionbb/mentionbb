...
class __TwigTemplate_32864ab15ad7d175a7a14af1e2514b62 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t";
                ...
                // line 26
                echo "\t\t\t\t\t";
                if ((((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "timer", [], "any", false, false, false, 26), "date", [], "any", false, false, false, 26), "getTimestamp", [], "method", false, false, false, 26) - (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "timer", [], "any", false, false, false, 26), "date", [], "any", false, false, false, 26), "addHour", [0 => 24], "method", false, false, false, 26) - twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "timer", [], "any", false, false, false, 26), "date", [], "any", false, false, false, 26), "getTimestamp", [], "method", false, false, false, 26))) - twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "dateline", [], "any", false, false, false, 26)) < (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "timer", [], "any", false, false, false, 26), "date", [], "any", false, false, false, 26), "addHour", [0 => 24], "method", false, false, false, 26) - twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "timer", [], "any", false, false, false, 26), "date", [], "any", false, false, false, 26), "getTimestamp", [], "method", false, false, false, 26)))) {
                    // line 27
                    echo "\t\t\t\t\t\t<div class=\"new-post ml-auto mt-lg-auto mb-lg-1 ml-lg-0 d-inline-flex align-items-center\">
\t\t\t\t\t\t\t<span title=\"";
                    // line 28
...
\t\t\t\t\t";
            ...
            // line 47
            echo "\t\t\t\t\t";
            if ((twig_length_filter($this->env, ($context["indexPosts_Content"] ?? null)) > 450)) {
                // line 48
                echo "\t\t\t\t\t\t<p class=\"mt-1\">";
...
\t\t\t\t\t\t";
            // line 53
            if ((twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "firstpost_id", [], "any", false, false, false, 53) == twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "post_id", [], "any", false, false, false, 53))) {
                // line 54
