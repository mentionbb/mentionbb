...
class __TwigTemplate_9a7a3d22998cf6e3fcfcc3abff66371659a127a02a832d1425c990785db5f557 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        $macros["macros"] = $this->macros["macros"] = $this->loadTemplate("macro.account_posts.tpl", "account_bookmarks_posts.tpl", 1)->unwrap();
        // line 2
        echo "
";
        // line 3
...
";
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["string"] ?? null), "post", [], "any", false, false, false, 11), "getUserBookmarksPosts", [0 => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "visitor", [], "any", false, false, false, 11), "user_id", [], "any", false, false, false, 11), 1 => ($context["wherePage"] ?? null), 2 => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "settings", [], "any", false, false, false, 11), "per_page", [], "any", false, false, false, 11)], "method", false, false, false, 11));
        $context['_iterated'] = false;
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 12
            echo "\t";
            echo twig_call_macro($macros["macros"], "macro_posts", [$context["item"], ($context["string"] ?? null), "bookmarks"], 12, $context, $this->getSourceContext());
            echo "
";
...
\t\t</div>
    ";
        ...
        // line 30
        if (0 === twig_compare(($context["page_id"] ?? null), twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["string"] ?? null), "post", [], "any", false, false, false, 30), "getUserBookmarksLastPage", [0 => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "visitor", [], "any", false, false, false, 30), "user_id", [], "any", false, false, false, 30)], "method", false, false, false, 30))) {
        } else {
            // line 32
...
\t\t<button type=\"button\" class=\"btn btn-app-load-more mb-3\" data-current-page=\"";
            ...
            echo "\" data-ui=\"load-more-user-bookmarks-posts\">";
...
";
    ...
    {
        return "account_bookmarks_posts.tpl";
    }
...
\t</div>
{% endif %}", "account_bookmarks_posts.tpl", "C:\\wamp64\\www\\mention\\src\\Templates\\Default\\User\\account_bookmarks_posts.tpl");
    }
}
