...
/* profile_posts.tpl */
class __TwigTemplate_c4e68f6324cb48d8118018a23f1633cf1e98592524e7bd9436ad5992c34fdbdd extends Template
{
    private $source;
    private $macros = [];
...
\t\t</div>
    ";
        ...
        // line 48
        if ((0 === twig_compare(($context["page_id"] ?? null), twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["string"] ?? null), "post", [], "any", false, false, false, 48), "getLastPage", [], "method", false, false, false, 48)) || 0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["string"] ?? null), "post", [], "any", false, false, false, 48), "getLastPage", [], "method", false, false, false, 48), 0))) {
        } else {
            // line 50
