...
/* new.tpl */
class __TwigTemplate_9c7f8177cccaac0a491cf2b17ea769420ce67116d59bf0533207843b9c5aab86 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("{% if not app.user.getActiveBan(app.visitor.user_id) %}
