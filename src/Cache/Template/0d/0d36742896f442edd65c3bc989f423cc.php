...
class __TwigTemplate_ea7989541874d73740ee327dde8a6562 extends Template
{
    private $source;
    private $macros = [];
...
\t\t</div>
    ";
        ...
        // line 30
        if ((($context["page_id"] ?? null) == twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["string"] ?? null), "post", [], "any", false, false, false, 30), "getUserBookmarksLastPage", [0 => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "visitor", [], "any", false, false, false, 30), "user_id", [], "any", false, false, false, 30)], "method", false, false, false, 30))) {
        } else {
            // line 32
