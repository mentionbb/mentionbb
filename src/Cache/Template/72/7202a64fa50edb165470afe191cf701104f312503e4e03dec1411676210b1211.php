...
class __TwigTemplate_dbdfb6a1179aae36a0f882f06412687e72112a6eaecc774b9dcf78acf12aa7ba extends Template
{
    private $source;
    private $macros = [];
...
\t\t</div>
    ";
        ...
        // line 30
        if (0 === twig_compare(($context["page_id"] ?? null), twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["string"] ?? null), "post", [], "any", false, false, false, 30), "getUserLikesLastPage", [0 => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "visitor", [], "any", false, false, false, 30), "user_id", [], "any", false, false, false, 30)], "method", false, false, false, 30))) {
        } else {
            // line 32
