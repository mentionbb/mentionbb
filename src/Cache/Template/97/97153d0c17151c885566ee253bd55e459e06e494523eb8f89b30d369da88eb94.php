...
/* conversation.tpl */
class __TwigTemplate_5cae1e249f88facd785ef1b2c2500bf1336063433bec2343d892e10ea2b8ba90 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t";
        // line 33
        if ( !twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["string"] ?? null), "conversation", [], "any", false, false, false, 33), "is_archived", [], "any", false, false, false, 33)) {
            // line 34
...
\t";
        // line 121
        if ( !twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["string"] ?? null), "conversation", [], "any", false, false, false, 121), "is_archived", [], "any", false, false, false, 121)) {
            // line 122
