...
/* messages.tpl */
class __TwigTemplate_5ba42b70f44940ac99378315b23ecb71a7e48e98f23ec596bc3d45c434876899 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t";
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["string"] ?? null), "conversation", [], "any", true, true, false, 13)) {
            ...
            echo "</div>
\t\t\t\t\t";
        } elseif (0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source,         // line 15
($context["app"] ?? null), "request", [], "any", false, false, false, 15), "getPathInfo", [], "method", false, false, false, 15), "/messages/new")) {
            ...
            echo "</div>
\t\t\t\t\t";
        } elseif (0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source,         // line 17
