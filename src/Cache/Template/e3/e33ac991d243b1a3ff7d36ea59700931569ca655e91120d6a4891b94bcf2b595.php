...
class __TwigTemplate_86fd081fd9d9eef21cd3a008fd6dbe7d87288269df4c0ba6cb2d57aa9ce42bac extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t";
            ...
            // line 25
            echo "\t\t\t\t\t\t\t";
            if (1 === twig_compare(twig_length_filter($this->env, ($context["accountPosts_Content"] ?? null)), 450)) {
                // line 26
                echo "\t\t\t\t\t\t\t\t<p class=\"mt-1\">";
