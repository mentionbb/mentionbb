...
/* discussion.tpl */
class __TwigTemplate_17f853703db421d42bf56b5211def5ba extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t";
        // line 70
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["string"] ?? null), "post", [], "any", false, false, false, 70), "getDiscussionPostCount", [], "method", false, false, false, 70) > 2)) {
            // line 71
