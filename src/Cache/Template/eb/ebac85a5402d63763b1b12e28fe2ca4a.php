...
class __TwigTemplate_3110904ae6930620b9dfe8b9897d2966 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 23
        if ((($context["page_id"] ?? null) == twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["string"] ?? null), "post", [], "any", false, false, false, 23), "getLastPage", [], "method", false, false, false, 23))) {
        } else {
            // line 25
