...
/* index_posts.tpl */
class __TwigTemplate_7d491ef868f001d324e1872b4331f8183bf27c53b06c046f3a4c8024b6c4d424 extends Template
{
    private $source;
    private $macros = [];
...
\t\t";
        ...
        // line 71
        echo "\t";
        if (0 === twig_compare((($context["page_id"] ?? null) - 1), twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["string"] ?? null), "post", [], "any", false, false, false, 71), "getLastPage", [], "method", false, false, false, 71))) {
            // line 72
            echo "\t";
        } else {
            // line 73
