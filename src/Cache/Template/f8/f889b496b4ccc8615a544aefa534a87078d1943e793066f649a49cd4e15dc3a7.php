...
/* index.tpl */
class __TwigTemplate_f930266afe20dfc890e890fa082bb458dc372f949e8ce777a010fc682feee9ed extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t<div id=\"quick-search\" class=\"form-inline my-2 my-lg-0\">
\t\t\t\t\t\t\t<div class=\"input-group has-feedback has-clear mb-2\">
\t\t\t\t\t\t\t\t<input name=\"keyword\" class=\"form-control\" type=\"text\" placeholder=\"{{ app.sub.lang.string.index.search.placeholder }}\" aria-label=\"{{ app.sub.lang.string.container.buttons.search }}\">
