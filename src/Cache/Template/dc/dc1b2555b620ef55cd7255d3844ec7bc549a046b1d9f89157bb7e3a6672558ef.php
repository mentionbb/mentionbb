...
class __TwigTemplate_454a889776c1fec5a36d201c8c35e5f58bbbfc14c1dbb3cee0f548beb18e6283 extends Template
{
    private $source;
    private $macros = [];
        ...
        echo "</a>
                ...
                <div class=\"d-flex flex-column align-items-center justify-content-center mt-3\">
                    <div class=\"align-self-start col-lg-12 col-sm-12 mb-3\">
                        <div class=\"app-admin-template-selector js-AppAdmin_TemplateSelector position-relative d-flex\" data-default=\"";
        // line 41
...
\t\t\t\t<div class=\"d-lg-flex align-items-lg-center\">
                ...
                <div class=\"d-flex flex-column align-items-center justify-content-center mt-3\">
                    <div class=\"align-self-start col-lg-12 col-sm-12 mb-3\">
                        <div class=\"app-admin-template-selector js-AppAdmin_TemplateSelector position-relative d-flex\" data-default=\"{{ string.name }}\">
                            <div class=\"col-sm-3\">
                                <ul class=\"directory-list scrollable shadow-sm rounded-bottom mr-3\">
