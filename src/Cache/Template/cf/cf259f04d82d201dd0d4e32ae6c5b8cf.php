...
/* profile_tooltip.tpl */
class __TwigTemplate_80112d53f6c5c1352ed65e2ff69e30fa extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"d-flex align-items-center mt-3 mb-1\">
    <a href=\"";
        // line 50
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "sub", [], "any", false, false, false, 50), "user", [], "any", false, false, false, 50), "link", [], "any", false, false, false, 50), "getOnlyLink", [], "method", false, false, false, 50), "html", null, true);
        echo "\" class=\"btn btn-app-discussion no-anim-ui icon go mr-2 d-lg-none\">";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "sub", [], "any", false, false, false, 50), "lang", [], "any", false, false, false, 50), "string", [], "any", false, false, false, 50), "profile", [], "any", false, false, false, 50), "buttons", [], "any", false, false, false, 50), "go", [], "any", false, false, false, 50), "html", null, true);
        echo "</a>
    ";
        // line 51
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "user", [], "any", false, false, false, 51), "loggedIn", [], "method", false, false, false, 51)) {
            // line 52
            echo "\t\t";
            if ( !(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "visitor", [], "any", false, false, false, 52), "user_id", [], "any", false, false, false, 52) === twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["string"] ?? null), "user", [], "any", false, false, false, 52), "user_id", [], "any", false, false, false, 52))) {
                // line 53
                echo "\t\t\t<a href=\"";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "phrase", [], "any", false, false, false, 53), "buildLink", [0 => "messages", 1 => ["section" => "new", "id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["string"] ?? null), "user", [], "any", false, false, false, 53), "user_id", [], "any", false, false, false, 53)]], "method", false, false, false, 53), "html", null, true);
                echo "\" class=\"btn btn-app-discussion no-anim-ui icon plus\">";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "sub", [], "any", false, false, false, 53), "lang", [], "any", false, false, false, 53), "string", [], "any", false, false, false, 53), "profile", [], "any", false, false, false, 53), "buttons", [], "any", false, false, false, 53), "message", [], "any", false, false, false, 53), "html", null, true);
                echo "</a>
\t\t";
            }
            // line 55
...
";
        // line 57
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "sub", [], "any", false, false, false, 57), "user", [], "any", false, false, false, 57), "unsetUser", [], "method", false, false, false, 57), "html", null, true);
    }
    ...
    {
        return array (  177 => 57,  174 => 56,  171 => 55,  163 => 53,  160 => 52,  158 => 51,  152 => 50,  145 => 46,  139 => 43,  133 => 40,  127 => 37,  121 => 34,  115 => 31,  109 => 28,  102 => 23,  99 => 21,  96 => 20,  90 => 18,  84 => 16,  81 => 15,  79 => 14,  74 => 13,  68 => 11,  62 => 9,  60 => 8,  56 => 7,  50 => 5,  41 => 2,  37 => 1,);
    }
