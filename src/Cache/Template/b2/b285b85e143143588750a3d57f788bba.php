...
/* updateLike.tpl */
class __TwigTemplate_d8d9aef5d6bc86fa1c16aec9aa0a2d00 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t";
                // line 8
                if (((($context["like_count"] ?? null) == 2) && (twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 8) == 1))) {
                    echo " 
\t\t\t\t\t";
                    // line 9
...
($context["like_count"] ?? null) < 3) &&  !twig_get_attribute($this->env, $this->source, $context["loop"], "last", [], "any", false, false, false, 10))) {
                    ...
                    // line 12
                    echo "\t\t\t\t    ";
                } elseif ((($context["like_count"] ?? null) >= 3)) {
                    // line 13
                    echo "\t\t\t\t\t";
