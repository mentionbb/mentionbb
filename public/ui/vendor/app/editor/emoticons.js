 ...
 */
 ...
 !function($, window, document)
 {
    ...
    var initDatabase = function (editor, databaseUrl, databaseId) {
      ...
      var getEmoji = function (lib) {
        if (startsWith(lib.char, '<img')) {
          ...
          var parse = twemoji.parse(lib.char);
          return parse.replace(/src="([^"]+)"/, function (match, url) {
            return 'style="width: 22px"' + match + '';
          });
        }
      };
    ...
    function Plugin () {
      global.add('customEmoticons', function (editor, pluginUrl) {
